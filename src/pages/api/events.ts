...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  // Remove originalType and originalId before sending to client
  const latestEventsForClient: Event[] = latestEvents.map(({ originalType, originalId, ...rest }) => rest);
...
// Define an extended Event type to keep track of original type and id for deletion
